...
export class MiniProgramService {
  ...
  public getQRCode(params: QRCode, accessToken: string) {
    ...
    return axios.post<
      DefaultRequestResult & { contentType: string; buffer: Buffer }
    >(url, params);
  }
   ...
   * @returns
   */
  public getUnlimitedQRCode(
    params: GetUnlimitedQRCode,
    accessToken: string,
    config?: AxiosRequestConfig,
  ) {
    const url = `https://api.weixin.qq.com/wxa/getwxacodeunlimit?access_token=${accessToken}`;
    return axios.post<DefaultRequestResult | Buffer | string>(
      url,
      params,
      config,
    );
  ...
  public getCategory(accessToken: string) {
    ...
    return axios.get<
      DefaultRequestResult & { data: { id: number; name: string }[] }
    >(url);
  }
   ...
   */
  public getPubTemplateTitleList(
    params: PubTemplateTitleList,
    accessToken: string,
  ) {
  ...
  public addMessageTemplate(params: MessageTemplate, accessToken: string) {
    ...
    return axios.post<DefaultRequestResult & { priTmplId: string }>(
      url,
      params,
    );
  }
  ...
  //     this.logger.debug(
  //       `verifyMessagePush() query = ${JSON.stringify(req.query)}`,
  //     );
  //   }
  ...
  public expressLocalgetAllImmeDelivery(accessToken: string) {
    ...
    return axios.post<
      DefaultRequestResult & {
        list: { delivery_id: string; delivery_name: string }[];
      }
    >(url);
  }
   ...
   * @returns 
   */
  public expressLocalPreAddOrder(
    params: ExpressLocalPreAddOrder,
    accessToken: string,
  ) {
   ...
   * @returns 
   */
  public expressLocalPreCancelOrder(
    params: ExpressLocalPreCancelOrder,
    accessToken: string,
  ) {
   ...
   * @returns 
   */
  public expressLocalCancelOrder(
    params: ExpressLocalCancelOrder,
    accessToken: string,
  ) {
   ...
   * @returns
   */
  public expressLocalGetLocalOrder(
    params: ExpressLocalGetLocalOrder,
    accessToken: string,
  ) {
   ...
   * @returns
   */
  public expressLocalAbnormalConfirm(
    params: ExpressLocalAbnormalConfirm,
    accessToken: string,
  ) {
  ...
  public expressLocalAddLocalOrder(
    params: ExpressLocalAddLocalOrder,
    accessToken: string,
  ) {
